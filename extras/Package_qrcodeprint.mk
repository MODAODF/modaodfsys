...
$(eval $(call gb_Package_Package,macro_qrcodeprint,$(SRCDIR)/extras/source/QRcodePrint))

$(eval $(call gb_Package_add_files_with_dir,macro_qrcodeprint,$(LIBO_SHARE_FOLDER)/extensions/QRcodePrint,\
	Addons.xcu \
	description.xml \
