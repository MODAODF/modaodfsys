...
void TemplateLocalView::Populate ()
{
    ...
    for (sal_uInt16 i = 0; i < nCount; ++i)
    {
        ...
        for (sal_uInt16 j = 0; j < nEntries; ++j)
        {
            ...
            {
                //~ printf("OUString(PicPath + /b/ + ii + jj +.png = %s \n", OUStringToOString( OUString(PicPath + "/b/" + ii + jj +".png"), RTL_TEXTENCODING_UTF8 ).getStr());
...
void SfxTemplateLocalView::readlistdata()
{
    cachedata.clear();
    // read list.txt data to struct
    char line[200];
